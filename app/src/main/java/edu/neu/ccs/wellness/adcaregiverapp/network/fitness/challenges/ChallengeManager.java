...
import edu.neu.ccs.wellness.adcaregiverapp.network.fitness.interfaces.AvailableChallengesInterface;
import edu.neu.ccs.wellness.adcaregiverapp.network.fitness.interfaces.ChallengeManagerInterface;
import edu.neu.ccs.wellness.adcaregiverapp.network.fitness.interfaces.ChallengeStatus;
...
import edu.neu.ccs.wellness.adcaregiverapp.network.server.WellnessRepository;
...
public class ChallengeManager implements ChallengeManagerInterface {
     ...
     */
    @Override
    public edu.neu.ccs.wellness.adcaregiverapp.network.server.RestServer.ResponseType syncRunningChallenge() {
        try {
            JSONObject jsonObject = this.getSavedChallengeJson();
            ...
            this.saveChallengeJson();
            return edu.neu.ccs.wellness.adcaregiverapp.network.server.RestServer.ResponseType.SUCCESS_202;
        } catch (JSONException e) {
            e.printStackTrace();
            return edu.neu.ccs.wellness.adcaregiverapp.network.server.RestServer.ResponseType.BAD_JSON;
        } catch (IOException e) {
            e.printStackTrace();
            return edu.neu.ccs.wellness.adcaregiverapp.network.server.RestServer.ResponseType.NO_INTERNET;
        }
    }
