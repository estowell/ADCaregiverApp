...
import edu.neu.ccs.wellness.adcaregiverapp.wellnessLib.fitness.interfaces.AvailableChallengesInterface;
import edu.neu.ccs.wellness.adcaregiverapp.wellnessLib.fitness.interfaces.ChallengeManagerInterface;
import edu.neu.ccs.wellness.adcaregiverapp.wellnessLib.fitness.interfaces.ChallengeStatus;
import edu.neu.ccs.wellness.adcaregiverapp.wellnessLib.fitness.interfaces.UnitChallengeInterface;
import edu.neu.ccs.wellness.adcaregiverapp.wellnessLib.server.RestServer;
import edu.neu.ccs.wellness.adcaregiverapp.wellnessLib.server.WellnessRepository;
import edu.neu.ccs.wellness.adcaregiverapp.wellnessLib.server.WellnessRestServer;
...
public class ChallengeManager implements ChallengeManagerInterface {
     ...
     */
    @Override
    public edu.neu.ccs.wellness.adcaregiverapp.wellnessLib.server.RestServer.ResponseType syncRunningChallenge() {
        try {
            JSONObject jsonObject = this.getSavedChallengeJson();
            ...
            this.saveChallengeJson();
            return edu.neu.ccs.wellness.adcaregiverapp.wellnessLib.server.RestServer.ResponseType.SUCCESS_202;
        } catch (JSONException e) {
            e.printStackTrace();
            return edu.neu.ccs.wellness.adcaregiverapp.wellnessLib.server.RestServer.ResponseType.BAD_JSON;
        } catch (IOException e) {
            e.printStackTrace();
            return edu.neu.ccs.wellness.adcaregiverapp.wellnessLib.server.RestServer.ResponseType.NO_INTERNET;
        }
    }
